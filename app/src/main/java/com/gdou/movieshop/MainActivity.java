...
public class MainActivity extends AppCompatActivity implements BottomNavigationBar.OnTabSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationBar
                ...
                .setMode(BottomNavigationBar.MODE_FIXED)  //MODE_FIXED 固定模式：未选中的Item显示文字，无切换动画效果。


                .setBackgroundStyle(BottomNavigationBar.BACKGROUND_STYLE_STATIC) //BACKGROUND_STYLE_STATIC: 静态样式 点击无波纹效果
